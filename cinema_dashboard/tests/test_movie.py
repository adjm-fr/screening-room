"""Tests for utils.movie — the movie detail page's data assembly.
...
import pandas as pd
import pytest
from utils.movie import MIN_SHARED_THEMES, load_movie, movie_screenings, similar_films, split_values
