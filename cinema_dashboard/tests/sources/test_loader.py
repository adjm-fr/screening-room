...
def test_attach_streaming_no_tmdb_id_column(mocker):
    ...
    load = mocker.patch("sources.loader.load_streaming_providers")
...
def test_attach_streaming_empty_cache_returns_empty_lists(mocker):
    ...
    mocker.patch(
        "sources.loader.load_streaming_providers",
...
def test_attach_streaming_left_join_preserves_unmatched(mocker):
    ...
    mocker.patch("sources.loader.load_streaming_providers", return_value=cache)
