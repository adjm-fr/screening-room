...
from pages.calendar import _to_calendar_events
...
def test_basic_event_shape(make_events_df):
    df = make_events_df(
        [
            {
                "french_title": "Dune",
...
def test_missing_runtime_defaults_to_120min(make_events_df):
    df = make_events_df(
        [
            {
                "french_title": "Dune",
...
def test_nat_showtime_skipped(make_events_df):
    df = make_events_df(
        [
...
def test_theater_id_fallback_when_name_missing(make_events_df):
    df = make_events_df(
        [
            {
                "french_title": "Dune",
