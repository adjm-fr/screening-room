...
held-out rating, so the provisional constants in :mod:`core.taste`
...
**Why raw scores, not the 0-100 match value.** :func:`core.taste.score_films`
...
def raw_scores(
    ...
    *,
    ...
    Mirrors :func:`core.taste.score_films`'s ``iterrows`` loop but stops
...
def evaluate(
    ...
    *,
    ...
    ``quality_weight`` term survives in :func:`core.taste._raw_score`'s
