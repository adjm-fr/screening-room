"""Tests for utils.chat_tools — the pure ``top_matches`` / ``showtimes_query`` handlers.
...
import pandas as pd
import pytest
from utils.chat_tools import MAX_SHOWTIME_ROWS, MAX_TOP_MATCHES, showtimes_query, top_matches
